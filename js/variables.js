...
var mobileMenuTitle = "Menu", //The title of the mobile menu
  ...
  map_color = "#a9c3b6", //Google map color
  map_initial_zoom = 15, //The initial zoom when Google map loads
  map_initial_latitude = 43.9577124, //Google map initial Latitude. If "null", the latitude of the first marked will be used
  map_initial_longitude = 5.5920787, //Google map initial Longitude. If "null", the longitude of the first marked will be used
